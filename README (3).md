...
| 7 | [Canadian Household Spending Analysis — SHS PUMF 2017–2023](#project-7) | Public Data Analytics | Python · pandas · SQLAlchemy · Azure SQL · Power BI · Statistics Canada |
...
## Project 7 — Canadian Household Spending Analysis · SHS PUMF 2017–2023

**EN:** End-to-end public data analytics project analyzing Canadian household spending patterns across **four survey cycles (2017, 2019, 2021, and 2023)** using Statistics Canada's Survey of Household Spending Public Use Microdata Files (SHS PUMF). The project covers the full pipeline: data cleaning and harmonization, weighted statistical analysis with bootstrap confidence intervals, sector deep dives into Food & Consumer and Insurance, comparative analysis across income quintiles, tenure groups, and provinces, and a 2023 official aggregate bridge extending the analysis beyond the COVID-affected 2021 year. All results are stored in **Azure SQL** (16 tables · 3 raw microdata years + 2023 official aggregate) and visualized in a **Power BI dashboard** connected live to the cloud database.

The analysis spans **17,590 harmonized household records** across three PUMF microdata years, covering 441 variables in 2017, 404 in 2019, and 398 in 2021, plus the official 2023 aggregate extension with 44,265 records from Statistics Canada published tables.

### Research Question

Why do Canadian household spending patterns vary across provinces, income quintiles, and tenure groups — and how did those differences evolve between 2017, 2019, 2021, and 2023, particularly in food, shelter, and insurance?
...
| 2023 | Statistics Canada Official Aggregate | 44,265 records | 16 | Official table bridge |

### Key Findings

**Income & Essential Burden**
* Average household income rose from **$84,689 (2017) → $92,883 (2019) → $103,048 (2021)** — a 21.7% increase. By 2023, the official aggregate reflects continued income growth post-COVID structural shift.
* Households in the **lowest income quintile (Q1)** spent **101.0% of their income on shelter + food + transport combined in 2017**, and **106.5% in 2019** — leaving nothing for anything else. By 2021 that figure eased to **90.9%**, still meaning 9 of every 10 dollars earned went to just three essentials.
* The **top quintile (Q5)** carried a combined burden of just **28–34%** across the same years — leaving the majority of income free for savings, discretionary spending, and wealth-building.

**Shelter**
* **British Columbia** had the highest shelter burden in every year: **24.8% (2017) · 25.0% (2019) · 23.3% (2021)** — verified with bootstrap 95% confidence intervals.
* **Ontario** was consistently second at **23.4% · 22.3% · 21.1%**.
* **Q1 shelter burden** reached **53.6% in 2017 and 55.1% in 2019** before easing to 48.0% in 2021 — statistically distinct from all other quintiles in every year.
* **Renters** faced shelter burdens of **26.5% · 26.2% · 24.0%** vs. **12.5% · 13.2% · 11.7%** for owners without a mortgage — less than half the burden.
* Residual income gap by tenure: owners without mortgages had **$60K–$74K** left after essentials; renters had **$22K–$33K**.

**Food**
* Total household food spending rose **21.0%** from **$8,529 (2017) to $10,318 (2019)** and remained flat at $10,306 in 2021.
* **Restaurant share collapsed** from **30.4% (2017) → 26.9% (2019) → 21.3% (2021)** as COVID-era behaviour shifted spending to grocery stores. Store share rose to **78.2%** by 2021.
* Strongest subcategory growth: **cereal grains +44.5%**, **dairy +38.3%**, **meat +36.7%** (2017–2021).
* **Q1 food burden**: **22.5% · 25.7% · 23.3%** — more than 3× the Q5 burden of **7.0% · 7.7% · 7.0%**.
* **2023 bridge**: national food expenditure structure shows continued dominance of store-based food; restaurant share partially recovering from 2021 COVID low.

**2023 Official Bridge**
* The 2023 extension uses Statistics Canada's published official aggregate table (11-10-0222-01) rather than PUMF microdata, as the 2023 PUMF has not yet been released publicly as of April 2026.
* It is strongest for national expenditure levels, food and shelter channel structure, and provincial spending pattern comparisons.
* It does not reproduce quintile analysis, tenure analysis, or bootstrap confidence intervals at the same granularity as the PUMF years.

### Azure SQL Infrastructure

All cleaned, harmonized, and analytical outputs are stored in **Azure SQL (Canada Central)** — server: `shs-pumf-server`, database: `shs-pumf-db` — with **16 tables** loaded via Python/SQLAlchemy from Jupyter notebooks.
...
Connected live to Azure SQL. 4 pages covering income quintile analysis, shelter burden by province and tenure, national spending trends 2017–2021, and comparative averages by year.

### Pipeline

```
Statistics Canada SHS PUMF (2017 · 2019 · 2021) + Official 2023 Aggregate
...
→ Power BI Dashboard (live connection to Azure SQL)
```
...
* Canadian household spending & affordability analytics
