...
| 6 | [FINTRAC Compliance Risk Analysis — Canadian Financial Institutions (2020–2026)](#project-6) | Regulatory Analytics | Excel · Power BI · FINTRAC · OSFI · AML/ATF |
...
[![Dashboard Overview](https://github.com/ebseducacioncolombia-tech/data-ai-portfolio/raw/main/images/dashboard_overview.png)](https://github.com/ebseducacioncolombia-tech/data-ai-portfolio/blob/main/images/dashboard_overview.png)
...
## Project 6 — FINTRAC Compliance Risk Analysis · Canadian Financial Institutions (2020–2026)

## Proyecto 6 — Análisis de Riesgo de Cumplimiento FINTRAC · Instituciones Financieras Canadienses (2020–2026)
...
| Largest single penalty / Mayor penalidad individual | **$176.9M CAD — Xeltox Enterprises Ltd. (Cryptomus), BC** |
...
* **Xeltox Enterprises Ltd.** (aka Cryptomus, formerly Certa Payments Ltd.) — a foreign MSB incorporated in BC, operating from Uzbekistan and Spain with no Canadian employees — received a $176.9M penalty for 2,593 contraventions across 6 violation types, representing **75% of all AMP in the dataset**. Currently under Federal Court appeal.
...
* **Fintech sector** generated only 22 violations but **$203.1M in penalties** (86.4% of total AMP) — driven almost entirely by the Xeltox outlier. Adjusted Fintech (excluding Xeltox): $26.2M across 6 entities.
...
| --- | --- |
| Integrity & Security Risk | Xeltox $176.9M (2,593 contraventions) — AI-driven financial crime materialization |
...
### Case Spotlight / Caso Destacado — Xeltox Enterprises Ltd. (aka Cryptomus)

> Foreign MSB incorporated in BC · Operating from Uzbekistan and Spain · No Canadian employees · **$176.9M CAD · 2,593 contraventions · 6 violation types · Under Federal Court appeal**
>
> **Why 2,593 contraventions but 6 types?** Each violation type was repeated thousands of times. 6 types × repeated instances = 2,593 contraventions for penalty calculation.
>
> **6 Violation Types:** (1) Failure to register as FMSB · (2) Unreported STRs · (3) Ministerial directive non-compliance · (4) Missing AML policies · (5) No ML/TF risk assessment · (6) Unreported LVCTs
...
→ Power BI Risk Dashboard (KPIs · trend · sector · province)
...
* **Power BI Risk Dashboard** — KPIs, enforcement trend, sector profile, provincial heatmap
